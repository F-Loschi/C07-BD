...
-- Tabela: Padrinhos (COM ON DELETE CASCADE nas relações apropriadas)
...
-- Tabela: CriancaFazDesejos (relação N:N entre Criança e Desejos COM CASCADE)
...
-- Tabela: Magia (COM CASCADE na relação com Padrinhos)
